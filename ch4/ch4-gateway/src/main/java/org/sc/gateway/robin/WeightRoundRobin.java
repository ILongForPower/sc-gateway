...
public abstract class WeightRoundRobin{
	...
	protected List<WeightServer> servers = new ArrayList<WeightServer>();
    ...
    */
	public Server getServer(List<WeightServer> servers){
		while(true){
...
//		}
	...
	public abstract Server choose(List<? extends Server> servers);
